...
public class CharController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            leftArm.transform.eulerAngles = new Vector3(30, leftArm.transform.eulerAngles.y, leftArm.transform.eulerAngles.z);
            friendsLeftArm.transform.eulerAngles = new Vector3(30, friendsLeftArm.transform.eulerAngles.y, friendsLeftArm.transform.eulerAngles.z);
        }

        if (Input.GetKeyDown(KeyCode.M))
        {
            rightArm.transform.eulerAngles = new Vector3(30, rightArm.transform.eulerAngles.y, rightArm.transform.eulerAngles.z);
            friendsRightArm.transform.eulerAngles = new Vector3(30, friendsRightArm.transform.eulerAngles.y, friendsRightArm.transform.eulerAngles.z);
        }
